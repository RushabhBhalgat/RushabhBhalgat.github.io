...
window.portfolioConfig = {
  ...
  projects: [
    {
      ...
      description: "AI-powered career development platform with smart resume enhancements, mock interviews, and personalized career roadmaps. Built with modern technologies for optimal performance.",
    ...
    },
    {
      ...
      categories: ["ai", "web"],
      description: "Smart India Hackathon project featuring AI-driven voice analysis, game-based assessments, and personalized development plans for comprehensive candidate evaluation.",
    ...
    },
    {
      ...
      description: "Global platform serving 500+ clients across 20+ countries. Built with WordPress and optimized for performance, SEO, and international scalability.",
  ...
  seo: {
    ...
    description: "Portfolio showcasing AI projects, software development expertise, and innovative solutions",
    keywords: "AI Developer, Software Engineer, Machine Learning, Full Stack Developer, Portfolio",
